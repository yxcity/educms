...
(function () {
    ...
    window.UEDITOR_CONFIG = {
    	...
    	, toolbars:[
                ['bold', 'italic', 'underline', 'fontborder', 'strikethrough', 'autotypeset', 'blockquote', 'pasteplain', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'selectall', 'cleardoc', '|',
                    'rowspacingtop', 'rowspacingbottom', 'lineheight', '|','insertvideo', 
                    'customstyle', 'paragraph', 'fontfamily', 'fontsize', '|',
                    'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify','link', 'unlink','insertimage', 'date', 'time'
                    ]
        ]
...
editor.render('content');  //editor为编辑器容器的id
