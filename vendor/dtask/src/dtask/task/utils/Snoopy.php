...
class Snoopy
{
	...
	var $agent			=	"Mozilla/5.0 (Windows NT 5.2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/29.0.1547.57 Safari/537.36";	// agent we masquerade as
	...
	function _httpsrequest($url,$URI,$http_method,$content_type="",$body="")
	{
		...
		if (function_exists('curl_init')) {
			...
			$results = implode('',array_slice($parts,1));
			unset($parts);
		} else {
